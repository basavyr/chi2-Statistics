...
double chiSuqaredMinimize(double izero, double particlePotential)
{
    ...
    while (ok)
    {
        ...
        {
            temp = pow((double)(tsd1[i] - energyBand1(spin1Exp[i], oddSpin, izero, beta, gamma, particlePotential)), 2.0);
            if (isnan(temp))
            {
                ok = false;
                break;
        ...
        {
            temp = pow((double)(tsd2[i] - energyBand2(spin2Exp[i], oddSpin, izero, beta, gamma, particlePotential)), 2.0);
            if (isnan(temp))
            {
                ok = false;
                break;
        ...
        {
            temp = pow((double)(tsd3[i] - energyBand3(spin3Exp[i], oddSpin, izero, beta, gamma, particlePotential)), 2.0);
            if (isnan(temp))
            {
                ok = false;
                break;
        ...
        {
            temp = pow((double)(tsd4[i] - energyBand4(spin4Exp[i], oddSpin, izero, beta, gamma, particlePotential)), 2.0);
            if (isnan(temp))
            {
                ok = false;
                break;
